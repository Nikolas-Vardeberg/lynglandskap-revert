...
import { serviceBySlugQuery, servicePathsQuery } from '../../sanity/lib/sanity.queries'
import {
  getFooter,
  getNavigation,
  getPageBySlug,
...
export default function ServiceSlugRoute(props: PageProps) {
...
export const getStaticPaths = async () => {
  const paths = await getPagePaths(servicePathsQuery)
